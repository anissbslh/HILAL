...
from hmap.models.AlexNet import AlexNet_CIFAR
from hmap.datasets.CIFAR100 import CIFAR100

device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")

class AlexNetCIFAR100(TrainerEvaluator):
    def instantiate_model(self):
        return AlexNet_CIFAR(num_classes=100).to(device)
