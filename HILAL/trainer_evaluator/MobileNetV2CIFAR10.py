...
from HILAL.models.MobileNetV2 import MobileNetV2
from HILAL.datasets import CIFAR10

device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")

class MobileNetV2CIFAR10(TrainerEvaluator):
    def instantiate_model(self):
        return MobileNetV2_CIFAR(num_classes=10).to(device)
